...
player2 = Person("Baako", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Ragna", 3089, 174, 288, 34, player_spells, player_items)

enemy1 = Person("Imp  ", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Vorgo", 18200, 701, 525, 25, enemy_spells, [])
...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            # Check if enough MP to cast spell
